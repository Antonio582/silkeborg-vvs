...
export const metadata: Metadata = {
  ...
  description:
    "Professionel VVS-installation i Silkeborg. Vandinstallation, badeværelse, køkken, vandrør og sanitetsudstyr. Autoriseret VVS-installatør med mange års erfaring. Ring [TELEFON].",
  alternates: {
  ...
  twitter: {
    ...
    title: "VVS-installation i Silkeborg | Autoriseret VVS-installatør",
    description: "Professionel VVS-installation i Silkeborg. Vandinstallation, badeværelse, køkken og sanitetsudstyr. Ring for tilbud.",
