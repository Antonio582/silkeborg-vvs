...
export const metadata: Metadata = {
  ...
  description:
    "Professionel VVS-installation i Silkeborg. Vandinstallation, badeværelse, køkken og sanitetsudstyr. Autoriseret VVS-installatør. Kontakt os.",
  alternates: {
  ...
  twitter: {
    ...
    title: "VVS-installation i Silkeborg | Autoriseret VVS-installatør",
    description: "Professionel VVS-installation i Silkeborg. Vandinstallation, badeværelse, køkken og sanitetsudstyr. Få tilbud.",
