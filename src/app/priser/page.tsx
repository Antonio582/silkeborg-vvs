...
export const metadata: Metadata = {
  ...
  description:
    "Se vores priser for VVS-arbejde i Silkeborg. Gennemsigtige og konkurrencedygtige priser for VVS-installation, varmepumper, blikkenslager og kloak. Ring [TELEFON].",
  alternates: {
  ...
  twitter: {
    ...
    title: "VVS Priser Silkeborg | Gennemsigtige priser",
    description: "Se priser for VVS-arbejde i Silkeborg. Gennemsigtige priser for VVS, varmepumper, blikkenslager og kloak. Ring for tilbud.",
